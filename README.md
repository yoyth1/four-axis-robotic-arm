...
{}^0T_H =
\begin{bmatrix}
C_{234}C_1C_5 - S_1S_5 & S_{234}C_1 & C_1 C_{234}S_5 + S_1C_5 & C_1(a_1 + d_5 S_{234} + a_3 C_{23} + a_2 C_2) \\
C_1S_5 + S_{234}S_1C_5 & S_{234}S_1 & S_1 C_{234}S_5 - C_1C_5 & S_1(a_1 + d_5 S_{234} + a_3 C_{23} + a_2 C_2) \\
-S_{234}C_5 & C_{234} & -S_{234}S_5 & d_5 C_{234} + a_3 S_{23} - a_2 S_2 \\
0 & 0 & 0 & 1
\end{bmatrix}
$$
...
C_3 =
\frac{
\left(d_5 o_z - p_z\right)^2 +
\left(\dfrac{p_y - d_5 o_y}{S_1} - a_1\right)^2 -
a_2^2 - a_3^2
}{
2 a_2 a_3
}
