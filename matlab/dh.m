...
L(4) = Link('revolute', 'd',0,'a',80,'alpha',0,'offset',25*pi/180,'qlim',[-150,150]/180*pi);
...
% T1 = bot.fkine(q);  %初始位置
% % pause      %  暂停   等待响应
% q2 = bot.ikine(T1,'mask',[1 1 1 1 0 0])   %  当反解的机器人对象的自由度少于6时，要用mask vector进行忽略某个关节自由度
% bot.plot(q2);
% 
